...
class ajoutCode:
    def __init__(self):
        ...
        interface.add_from_file('ajoutBase2.glade')
        ...
        self.Label = interface.get_object('label4')
    ...
    def on_button1_clicked(self, widget):
        ...
        nom = str(self.Entry2.get_text())
        prenom = str(self.Entry3.get_text())

        if code == '' or nom == '' or prenom == '':
            self.Label.set_text('Remplissez tous les champs !')

        else:
            try:
                cursor.execute("""INSERT INTO ids VALUES(?,?,?)""",(code,nom,prenom))
